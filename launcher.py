...
def save_profile(data):
    ...
    if data.get("_patch") and cfg_path.exists():
        ...
        for field in ["gold_min_pig", "perda_xp_max", "gold_ignorar_xp",
                       "score_min_pig", "score_min_pig_broke", "score_min_imunizacao", "gold_conta_broke",
                       "cookies",
    ...
    cfg  = {
        ...
        "score_min_pig":        data.get("score_min_pig", 70),
        "score_min_pig_broke":  data.get("score_min_pig_broke", 50),
        "score_min_imunizacao": data.get("score_min_imunizacao", 80),
        "gold_conta_broke":     data.get("gold_conta_broke", 100),
        "missao_alinhamento":         data.get("missao_alinhamento", "alternado"),
        "taverna_ativa":              data.get("taverna_ativa", True),
        "atacar_continuo":            data.get("atacar_continuo", False),
